...
describe('Helper Functions', function() {
    ...
    describe('other methods',function(){
        it('should round a number to a specified number of decimal places',function(done){
        ...
        it('should calculate wind chill properly',function(done){
            ...
            helpers.feels_like_temp(5,3,0).should.be.within(2.50,2.51);
            helpers.feels_like_temp(0,10,0).should.be.within(-7.04,-7.03);
            helpers.feels_like_temp(10,10,0).should.be.within(6.21,6.22);
            helpers.feels_like_temp(11,10,0).should.be.within(10.99,11.01); //temperature too high, should return input
            done();
        })
        it('should calculate heat index properly',function(done){
            //using within in case of mathematical weirdness and/or rounding issues
            helpers.feels_like_temp(27,0,15).should.be.within(26.98,27.99);
            helpers.feels_like_temp(30,0,50).should.be.within(31.04,31.05);
            helpers.feels_like_temp(40,0,40).should.be.within(48.26,48.27);
            helpers.feels_like_temp(50,0,75).should.be.within(49.99,50.01); //absurd relative humidity, should return original value
            helpers.feels_like_temp(25,0,90).should.be.within(24.99,25.01); //temperature too low, should return original value
            done();
        })
    })
})
