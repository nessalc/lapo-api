...
describe('Helper Functions', function () {
  ...
  describe('other methods', function () {
    ...
    it('should calculate wind chill properly', function (done) {
      ...
      helpers.getFeelsLikeTemp(11, 10, 0).should.be.within(10.99, 11.01) // temperature too high, should return input
      done()
    })
    it('should calculate heat index properly', function (done) {
      ...
      helpers.getFeelsLikeTemp(50, 0, 75).should.be.within(49.99, 50.01) // absurd relative humidity, should return original value
      helpers.getFeelsLikeTemp(25, 0, 90).should.be.within(24.99, 25.01) // temperature too low, should return original value
      done()
    })
  })
})
